...
if(isset($submit))
{
  ...
  $query="update property set title='$title',email='$email',bedroom='$bedroom',kichan='$kichan',price='$price',sqr_price='$sqr_price',address='$add',description='$description',bathroom='$bathroom',furnish='$furnish',property_owner='$property_owner',property_type='$property_type',lot_size='$lot_size',land_area='$land_area',sold='$sold' where p_id='$id'";
  ...
  $query="update property set title='$title',email='$email',bedroom='$bedroom',kichan='$kichan',price='$price',sqr_price='$sqr_price',address='$add',description='$description',bathroom='$bathroom',furnish='$furnish',property_owner='$property_owner',property_type='$property_type',lot_size='$lot_size',land_area='$land_area',sold='$sold',image='$file' where id='$id'";
  mysqli_query($con,$query);
                            ...
                            <form method="post" enctype="multipart/form-data">
                               ...
                               <h4 style="text-align: center;">Condition</h4>
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input  type="text" name="furnish" value="<?php echo $res['furnish'];?>" class="form-control">

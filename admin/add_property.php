...
$file=$_FILES['file']['name'];
  ...
  $query="INSERT INTO property (id, title, email, bedroom, kichan, bathroom, furnish, price, sqr_price, address, image, description, property_owner, property_type, lot_size, sold, land_area, dates) VALUES ('', '$title', '$email', '$bedroom', '$kitchan', '$bathroom', '$furnish', '$price', '$sqr_price', '$add', '$file', '$description', '$property_owner', '$property_type', '$lot_size', '$sold', '$land_area', now())";    
                            ...
                            <form method="post" enctype="multipart/form-data">
                               ...
                               <h4 style="text-align: center;">Condition</h4>
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <textarea required name="furnish" class="form-control"></textarea>

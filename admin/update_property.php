...
if(isset($submit))
{
  ...
  $query="update property set title='$title',email='$email',bedroom='$bedroom',hall='$hall',kichan='$kichan',price='$price',sqr_price='$sqr_price',address='$add',description='$description',bathroom='$bathroom',furnish='$furnish',property_owner='$property_owner',property_type='$property_type',lot_size='$lot_size',land_area='$land_area',sold='$sold' where p_id='$id'";
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                     ...
                                     <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input required type="text" name="email" value="<?php echo $res['title'];?>" class="form-control">
                                    ...
                                    <img src="../advertiser/images/property_image/<?php echo $img;?>" width="200">                              
                                     </div>                                            
                                      </div>
                                     ...
                                     <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                               ...
                                               <input name="furnish" type="radio"  <?php if($furnish=='Semi') echo 'checked';?> id="radio_35" value="Semi" class="with-gap radio-col-light-yellow"  />
                                                <label for="radio_35">Semi</label>

                                                <input name="furnish" type="radio"  <?php if($furnish=='Fully') echo 'checked';?> id="radio_31" value="Fully" class="with-gap radio-col-green"  />

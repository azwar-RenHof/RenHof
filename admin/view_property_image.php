...
$query=mysqli_query($con,"select * from property where p_id='$image_id'");
...
?>
                                            ...
                                            <td><img src="../advertiser/images/property_image/<?php echo $img1;?>" width="120"></td>
                                            <td><img src="../advertiser/images/property_image/<?php echo $img2;?>" width="120"></td>
                                            <td><img src="../advertiser/images/property_image/<?php echo $img3;?>" width="120"></td>
                                            <td><img src="../advertiser/images/property_image/<?php echo $img4;?>" width="120"></td>
                                             <td>
